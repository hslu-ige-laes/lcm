...
hotWaterFlatsModuleUI <- function(id) {
  #' Name UI
  #'
               ...
               fluidRow(
                 box(
                   ...
                   column(
                     ...
                     column(
                       width = 12,
                       includeMarkdown(here::here("docs", "docs", "modules","hotWaterFlats.md"))
                     )
                   )
                 )
               )
...
hotWaterFlatsModule <- function(input, output, session, aggData) {
  #' Name
  #'
