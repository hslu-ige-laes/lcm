...
1. selezionare  tramite il pulsante `Browse...` il file dei dati del campione `flatTempHumA.csv`. Questo file si trova nella cartella dell'applicazione nella sottocartella `/sampleData`
