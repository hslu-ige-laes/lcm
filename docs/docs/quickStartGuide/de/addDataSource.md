...
1. Wählen Sie über den Knopf `Browse...` die Beispieldatendatei `flatTempHumA.csv` aus. Diese Datei befindet sich in Ihrem Anwendungsordner im Unterordner `/sampleData`<br>
