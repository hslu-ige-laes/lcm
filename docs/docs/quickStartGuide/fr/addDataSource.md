...
1. Choisissez via le bouton `Browse...` le fichier de données d'exemple `flatTempHumA.csv`. Ce fichier est inclus dans votre dossier d'application dans le sous-dossier `/sampleData`<br>
